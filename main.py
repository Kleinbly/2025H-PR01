...
ball_velocity_x = random.choice([-1, 1]) * BALL_SPEED_X # Remplacer "0" par votre réponse
ball_velocity_y = random.choice([-1, 1]) * BALL_SPEED_Y # Remplacer "0" par votre réponse
